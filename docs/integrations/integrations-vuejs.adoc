...
. You need to add the Web Components polyfill to the [elementname]#head# section of your [filename]#index.html#.
This will allow the use of Vaadin Elements in all modern browsers.
+
[source, html]
.index.html
----
